...
RUN_NAME=${RUN_NAME:-"qwen2-5-vl-ins_dota-poly-trainval512_tune-all-plain-mode-keep-empty-gt-prob-random-resize-${PROB_RANDOM_RESIZE}_pix${MIN_PIXELS}-${MAX_PIXELS}_lr${LEARNING_RATE}-${EPOCHS}epochs_${NGPUS}gpus"}
