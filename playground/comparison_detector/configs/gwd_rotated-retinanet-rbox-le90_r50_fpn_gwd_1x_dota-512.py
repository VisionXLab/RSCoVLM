_base_ = [
    'mmrotate::gwd/rotated-retinanet-rbox-le90_r50_fpn_gwd_1x_dota.py'
]
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='./playground/comparison_detector/work_dirs/gwd_rotated-retinanet-rbox-le90_r50_fpn_gwd_1x_dota-512/dota_Task1')
