_base_ = [
    'mmrotate::rotated_faster_rcnn/rotated-faster-rcnn-le90_r50_fpn_1x_dota.py'
]
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='./playground/comparison_detector/work_dirs/rotated-faster-rcnn-le90_r50_fpn_1x_dota-512/dota_Task1')
