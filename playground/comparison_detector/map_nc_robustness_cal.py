...
def main(pickle_result_path: str, csv_result_path: str, dataset_name: str="dota", g: int=20):
    results = {}
...
if __name__ == "__main__":
    # python -u playground/comparison_detector/map_nc_robustness_cal.py --dataset_name dota --pickle_result_path playground/comparison_detector/work_dirs/r3det-oc_r50_fpn_1x_dota-512/output_test.pkl --csv_result_path playground/comparison_detector/work_dirs/r3det-oc_r50_fpn_1x_dota-512/results_val_score_threshold.csv
    Fire(main)